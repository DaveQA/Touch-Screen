...
public class PartSearchBackButton {
    ...
    public void backButtonSearchPartMainTest(WebDriver driver1) {
    ...
    private void backButtonOnTheSearchPartsPartScreen() {
        ...
        if (driver.findElement(By.cssSelector("h2")).getAttribute("innerHTML").contentEquals("Welcome to Pull-A-Part!" +
            ...
            System.out.println("Back button from Search Parts Parts screen working as intended.");
