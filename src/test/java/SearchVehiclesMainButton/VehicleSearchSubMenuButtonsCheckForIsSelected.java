...
public class VehicleSearchSubMenuButtonsCheckForIsSelected {
    ...
    public void searchVehiclesSubMenuButtonsMainTest(WebDriver driver1) {
        clickMainScreenSearchVehiclesButton(driver1);
        mostPopularButtonIsActive();
    ...
    private void mostPopularButtonIsActive() {
